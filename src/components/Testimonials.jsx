  ...
  const reviews = [
    {
      ...
      role: "Working Mother",
      comment:
        "Finding a reliable babysitter was so stressful until I found Care.xyz. The process was seamless and the caregiver was amazing!",
    ...
    },
    {
      ...
      role: "Entrepreneur",
      comment:
        "The elderly care service provided for my father was exceptional. Very professional and compassionate staff.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-500 font-medium">
            Building trust through transparency and compassion. Here is why
            families choose us.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {stats.map((stat) => (
            <div
              key={stat.id}
              className="p-10 rounded-[2.5rem] bg-white border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col items-center"
            >
              <div
                className={`w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mb-6 transition-transform group-hover:scale-110 ${stat.color}`}
              >
                {stat.icon}
              </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="bg-base-200/50 p-8 md:p-10 rounded-[3rem] relative border border-white shadow-sm hover:bg-white hover:shadow-xl transition-all duration-500 group"
            >
